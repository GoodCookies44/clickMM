...
export default function UMFPage() {
  return (
    <div>
      ...
      <section className="UMF__categories">
        <h2>Категории</h2>
        <p>
          <b>Техника:</b> «Техника для красоты и здоровья», «Наушники и аудиотехника», «Техника для
          дома», «Техника для кухни», «Игровые приставки», «Смартфоны», «Крупная бытовая техника»,
          «Климатическая техника».
        </p>
        <p>
          <b>Одежда:</b> «Женские платья и сарафаны», «Женские футболки и топы», «Женские блузки и
          рубашки», «Белье и купальники».
        </p>
        <p>
          <b>Косметика, личная гигиена и бытовая химия:</b> «Уход за лицом», «Уход за телом»,
          «Макияж», «Гигиена полости рта», «Средства для стирки», «Мыло», «Чистящие и моющие
          средства», «Парфюмерия».
        </p>
        <p>
          <b>Детские товары:</b> «Детское творчество», «Гигиена и подгузники», «Игрушки и игры».
        </p>
        <p>
          <b>Товары для взрослых:</b> «Секс-игрушки».
        </p>
        <p>
          <b>Дом и дача:</b> «Бассейны и аксессуары», «Удобрения и уход за растениями», «Товары для
          кухни», «Электроинструменты»,.
        </p>
      </section>

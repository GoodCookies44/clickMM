...
export default function ReportPage() {
  ...
  const generateReport = () => {
    ...
    const groups = {
      ...
      PM_group: [
        {text: "**ПМ/БП:**", id: ""},
        {text: "Предметка:", id: "PM_item"},
        {text: "Моделька:", id: "PM_model"},
        {text: "Ретушь:", id: "PM_retouch"},
        {text: "Инфографика:", id: "PM_infographic"},
        {text: "Вопрос:", id: "PM_ask"},
        {text: "Выгрузить/удалить:", id: "PM_unloading"},
        {text: "Корректировка:", id: "PM_adjustment"},
      ],

      Paid_group: [
        {text: "**Платная съёмка:**", id: ""},
        {text: "Предметка:", id: "Paid_item"},
        {text: "Моделька:", id: "Paid_model"},
        {text: "Ретушь:", id: "Paid_retouch"},
        {text: "Рендер:", id: "Paid_render"},
        {text: "Вопрос:", id: "Paid_ask"},
        {text: "Выгрузить:", id: "Paid_unloading"},
      ],

...
export default function ListItem({text}) {
  ...
  const [optionsByReason, setOptionsByReason] = useState({
    ...
    "Причина 5: На фотографиях имеется запрещенная символика или информация": [
      "алкоголь, наркотики, порнография, оружие, жестокость, а также экстремистская и запрещенная законодательством Российской Федерации символика и информация (радужные флаги, свастика, правый сектор и т.д.)",
    ],
